...
export const renderArtworkSharePage = ({ title, description, imageUrl, shareUrl, redirectUrl }: ArtworkSharePreview) => {
...
<meta property="og:type" content="website"><meta property="og:site_name" content="INKPROWL"><meta property="og:title" content="${safeTitle}"><meta property="og:description" content="${safeDescription}"><meta property="og:url" content="${safeShareUrl}"><meta property="og:image" content="${safeImageUrl}"><meta property="og:image:secure_url" content="${safeImageUrl}"><meta property="og:image:alt" content="${safeTitle}">
